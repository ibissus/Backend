...
namespace KompaniaPchor.Migrations
{
    ...
    [Migration("20190912215317_PCAssistants")]
    partial class PCAssistants
    {
            ...
            modelBuilder.Entity("KompaniaPchor.ORM_Models.Katalog", b =>
                {
                    ...
                    b.Property<int?>("IdKataloguNadrzednego");
            ...
            modelBuilder.Entity("KompaniaPchor.ORM_Models.Zolnierz", b =>
                {
                    ...
                    b.HasIndex("NrKompanii", "NrPlutonu");
            ...
            modelBuilder.Entity("KompaniaPchor.ORM_Models.Katalog", b =>
                {
                    b.HasOne("KompaniaPchor.ORM_Models.Katalog", "_KatalogNadrzedny")
                        ...
                        .HasForeignKey("IdKataloguNadrzednego")
                    ...
                    b.HasOne("KompaniaPchor.ORM_Models.Pluton", "_Pluton")
                        .WithMany("_Katalogi")
                        .HasForeignKey("NrPlutonu", "NrKompanii")
            ...
            modelBuilder.Entity("KompaniaPchor.ORM_Models.Zolnierz", b =>
                {
                    ...
                    b.HasOne("KompaniaPchor.ORM_Models.Pluton", "_Pluton")
                        .WithMany("_Zolnierze")
                        .HasForeignKey("NrKompanii", "NrPlutonu")
                        .HasConstraintName("FK_ZOLNIERZ_REFERENCE_PLUTON");

                    b.HasOne("KompaniaPchor.ORM_Models.Pluton")
                        .WithMany("_Funkcyjni")
                        .HasForeignKey("NrPlutonu", "NrKompanii");
                });
